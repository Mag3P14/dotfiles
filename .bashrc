...
##-----------------------------------------------------
## better-ls
if [ -f /home/martin/.config/synth-shell/better-ls.sh ] && [ -n "$( echo $- | grep i )" ]; then
	source /home/martin/.config/synth-shell/better-ls.sh
fi
...
export EDITOR=nvim
export PATH=/home/martin/.df:$PATH
export GIT_USERNAME=Mag3P14
export NNN_OPTS="nS"
export PATH=/usr/local/MATLAB/R2018a/bin/:$PATH

export PATH="${PATH}:${HOME}/.local/bin/"
export PATH="${PATH}:${HOME}/opt/pycharm-2024.2.1/bin/"
export TESSDATA_PREFIX="/usr/share/tesseract-ocr/4.00/tessdata/"
export PATH="${PATH}:${HOME}/home/martin/.local/bin/"
